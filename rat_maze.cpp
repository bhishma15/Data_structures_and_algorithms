...
Consider a rat placed at (0, 0) in a square matrix of order N*N.\
 ...
 'L' (left), 'R' (right). Value 0 at a cell in the matrix 
 represents that it is blocked and cannot be crossed while value\
  1 at a \
 cell in the matrix represents that it can be traveled through.
*/
